  ...
  return (
    ...
    >
      <div className="max-w-3xl flex flex-col items-center">
        ...
        <h1 className="animate-hero-item opacity-0 text-4xl font-bold tracking-tight text-neutral-900 sm:text-6xl font-poppins">
          Kabinet{" "}
          <span className="text-brand-primary">Laskar Purnama Antasari</span>
        </h1>
