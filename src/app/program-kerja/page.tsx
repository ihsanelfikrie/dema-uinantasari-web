            ...
            <div className="space-y-6">
              {upcomingEvents.map((keg) => (
                <FadeInSection key={keg.id}>
                  <div className="bg-white border border-neutral-100 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row gap-6 items-start hover:border-brand-primary/10 transition-colors">
